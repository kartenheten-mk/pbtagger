...
2. Kontrollera att dokumentet visas korrekt.
3. Importera eller kontrollera geometri.
4. Tagga relevanta delar i dokumentet.
5. Länka taggar till geometrier.
6. Kontrollera Planbeskrivning v2.0-status.
7. Exportera resultatet.
