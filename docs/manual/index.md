...
| Data-menyn | Importera, exportera tagg-ZIP, hantera `config.json` och redigera Planbeskrivning v2.0-inställningar. | [Import och export](import-export.md) |
...
8. Exportera taggad DOCX, tagg-ZIP, geometri med motiv eller hela projektet.
...
| ![Datamenyn](../assets/screenshots/datameny-export.png){ width="220" } | Import, tagg-ZIP-export, config och exportinställningar. |
